...
class RequirementsTest extends Specification {
    ...
    def "Requirement may only be set once"() {
        when:
        script.require(new ToolSpec(name: 'mytool', version: '1'))
        script.require(new ToolSpec(name: 'lala', version: '2'))
    ...
    def "Requirement may not contains duplicates of tools with the same name"() {
        when:
        script.require(
            new ToolSpec(name: 'mytool', version: '1.2.3'),
            new ToolSpec(name: 'mytool', version: '1.2.4'),
        )
